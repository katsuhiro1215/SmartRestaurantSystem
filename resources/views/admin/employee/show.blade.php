<x-app-layout>
    ...
    <x-grid>
        <div class="bg-green-300 border border-red-300 rounded px-4 py-3 col-span-1 sm:col-span-2 md:col-span-1">
            ...
            <div class="mt-4">
                <img src="{{ !empty($employeeProfile->employee_photo_path) ? url('storage/employees/' . $employeeProfile->employee_photo_path) : url('upload/kids.jpg') }}"
                    alt="" class="rounded-full w-36 h-36 mx-auto">
            </div>
            <div class="mt-4 text-center">
                <h3>名前: {{ $employeeProfile->full_name }}</h3>
            </div>
            <div class="mt-4 text-center">
                <x-link-button name="profileEdit"
                    href="{{ route('admin.employeeProfile.edit', ['employee' => $employee->id, 'employeeProfile' => $employee->employeeProfile->id]) }}" />
                <x-link-button name="edit"
                    href="{{ route('admin.employee.edit', ['employee' => $employee->id]) }}" />
            </div>
        </div>
                        ...
                        <tbody class="divide-y divide-red-200">
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">姓:</span>{{ $employeeProfile->lastname }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">名:</span>{{ $employeeProfile->firstname }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span
                                        class="text-sm text-gray-400 mr-2">セイ:</span>{{ $employeeProfile->lastname_kana }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span
                                        class="text-sm text-gray-400 mr-2">メイ:</span>{{ $employeeProfile->firstname_kana }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">生年月日:</span>{{ $employeeProfile->birth }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                            ...
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span
                                        class="text-sm text-gray-400 mr-2">都道府県名:</span>{{ $employeeProfile->address1 }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span
                                        class="text-sm text-gray-400 mr-2">市区町村名:</span>{{ $employeeProfile->address2 }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                    <span
                                        class="text-sm text-gray-400 mr-2">地域名:</span>{{ $employeeProfile->address3 }}
                                </td>
                            </tr>
                            <tr>
                                <th class="border border-slate-300 bg-gray-100 px-4 py-3 font-medium text-left"></th>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                    {{ $employeeProfile->address4 }}</td>
                            </tr>
                            <tr>
