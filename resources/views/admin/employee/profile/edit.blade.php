<x-app-layout>
  ...
  <div class="w-full mx-auto px-4 py-3 overflow-auto">
      @foreach ($errors->all() as $error)
          <li>{{ $error }}</li>
      @endforeach
      <form method="POST" action="{{ route('admin.employeeProfile.update', ['employeeProfile' => $employeeProfile->id]) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="w-full">
          ...
          <x-grid>
              <div class="mt-4 col-span-2 row-span-3">
                  ...
                  <x-text-input id="image" name="employee_photo_path" type="file" class="mt-1 block w-full"
                      :value="$employeeProfile->employee_photo_path" />
                  <img id="showImage"
              ...
              <div class="mt-4 col-span-1">
                  ...
                  <x-text-input id="lastname" name="lastname" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->lastname" required />
              ...
              <div class="mt-4 col-span-1">
                  ...
                  <x-text-input id="firstname" name="firstname" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->firstname" required />
              ...
              <div class="mt-4 col-span-1">
                  ...
                  <x-text-input id="lastname_kana" name="lastname_kana" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->lastname_kana" required />
              ...
              <div class="mt-4 col-span-1">
                  ...
                  <x-text-input id="firstname_kana" name="firstname_kana" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->firstname_kana" required />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="birth" name="birth" type="date" class="mt-1 block w-full"
                      :value="$employeeProfile->birth" autocomplete="birth" />
              ...
              <div class="mt-4">
                  ...
                  <div class="flex">
                      <div class="flex items-center mr-4">
                        <x-radio-input id="male" name="gender" value="男性" :checked="old('gender', $employeeProfile->gender) === '男'" />
                          <x-radio-label for="male" :value="__('男性')" />
                      </div>
                      <div class="flex items-center mr-4">
                        <x-radio-input id="female" name="gender" value="女性" :checked="old('gender', $employeeProfile->gender) === '女'" />
                          <x-radio-label for="female" :value="__('女性')" />
                      </div>
                      <div class="flex items-center mr-4">
                        <x-radio-input id="others" name="gender" value="その他" :checked="old('gender', $employeeProfile->gender) === 'その他'" />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="zipcode" name="zipcode" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->zipcode" autocomplete="zipcode" />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="address1" name="address1" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->address1" autocomplete="address1" placeholder="都道府県名を入力してください。" />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="address2" name="address2" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->address2" autocomplete="address2" placeholder="市区町村名を入力してください。" />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="address3" name="address3" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->address3" autocomplete="address3" placeholder="地域名を入力してください。" />
              ...
              <div class="mt-4 col-span-3">
                  ...
                  <x-text-input id="address4" name="address4" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->address4" autocomplete="address4" placeholder="それ以降を入力してください。" />
                  <x-input-error class="mt-2" :messages="$errors->get('address4')" />
              </div>
              <div class="mt-4">
                  <x-input-label for="phone_number" :value="__('電話番号')" />
                  <x-text-input id="phone_number" name="phone_number" type="text" class="mt-1 block w-full"
                      :value="$employeeProfile->phone_number" autocomplete="phone_number" placeholder="電話番号を入力してください。" />
              ...
              <div class="mt-4">
                  ...
                  <div class="flex">
                      <div class="flex items-center mr-4">
                          <x-radio-input id="active" name="status" value="利用中" :checked="old('status', $employeeProfile->status) === '利用中'" />
                          <x-radio-label for="active" :value="__('利用中')" />
                      </div>
                      <div class="flex items-center mr-4">
                          <x-radio-input id="inactive" name="status" value="停止中" :checked="old('status', $employeeProfile->status) === '停止中'" />
              ...
              <div class="mt-4 col-span-2">
                  ...
                  <div class="flex">
                      <div class="flex items-center mr-4">
                          <x-radio-input id="fullTime" name="role" value="正社員" :checked="old('role', $employeeProfile->role) === '正社員'" />
                          <x-radio-label for="fullTime" :value="__('正社員')" />
                      </div>
                      <div class="flex items-center mr-4">
                          <x-radio-input id="partTime" name="role" value="パート" :checked="old('role', $employeeProfile->role) === 'パート'" />
                          <x-radio-label for="partTime" :value="__('パート')" />
                      </div>
                      <div class="flex items-center mr-4">
                          <x-radio-input id="subPartTime" name="role" value="アルバイト" :checked="old('role', $employeeProfile->role) === 'アルバイト'" />
              ...
              <div class="mt-4">
                  ...
                  <x-text-input id="start_date" name="start_date" type="date" class="mt-1 block w-full"
                      :value="$employeeProfile->start_date" autocomplete="start_date" placeholder="Date" />
