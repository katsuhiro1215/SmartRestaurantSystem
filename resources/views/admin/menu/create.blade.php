<x-app-layout>
    ...
    <div class="w-full mx-auto px-4 py-3 overflow-auto">
        <form method="POST" action="{{ route('admin.menu.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="w-full">
                <h2 class="text-lg">Menu Create</h2>
            </div>
            <x-grid>
                ...
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="code" class="block mt-1 w-full" type="text" placeholder="自動生成されます。"
                        disabled />
                ...
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="slug" class="block mt-1 w-full" type="text" placeholder="自動生成されます。"
                        disabled />
                ...
                <div class="col-span-2">
                    <div class="mt-4">
                        ...
                        <x-textarea rows="8">{{ old('description') }}</x-textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-textarea rows="8">{{ old('detail') }}</x-textarea>
                ...
                <div class="col-span-2">
                    <div class="mt-4">
                        ...
                        <x-textarea rows="8">{{ old('description_en') }}</x-textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-textarea rows="8">{{ old('detail_en') }}</x-textarea>
