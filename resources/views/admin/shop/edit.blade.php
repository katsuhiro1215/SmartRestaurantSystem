<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semib$shop->ext-xl text-gray-800 leading-tight">
            {{ __('Shop') }}
        </h2>
    </x-slot>
            ...
            <x-grid>
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                        :value="$shop->name" required autocomplete="name" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="zipcode" name="zipcode" type="text" class="mt-1 block w-full"
                        :value="$shop->zipcode" autocomplete="zipcode" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address1" name="address1" type="text" class="mt-1 block w-full"
                        :value="$shop->address1" autocomplete="address1" placeholder="都道府県名を入力してください。" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address2" name="address2" type="text" class="mt-1 block w-full"
                        :value="$shop->address2" autocomplete="address2" placeholder="市区町村名を入力してください。" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address3" name="address3" type="text" class="mt-1 block w-full"
                        :value="$shop->address3" autocomplete="address3" placeholder="地域名を入力してください。" />
                ...
                <div class="mt-4 col-span-3">
                    ...
                    <x-text-input id="address4" name="address4" type="text" class="mt-1 block w-full"
                        :value="$shop->address4" autocomplete="address4" placeholder="それ以降を入力してください。" />
                    <x-input-error class="mt-2" :messages="$errors->get('address4')" />
                </div>
                <div class="mt-4 col-span-2">
                    <x-input-label for="email" :value="__('メールアドレス')" />
                    <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                        :value="$shop->email" required autocomplete="email" />
                    <x-input-error class="mt-2" :messages="$errors->get('email')" />
                </div>
                <div class="mt-4">
                    <x-input-label for="phone_number" :value="__('電話番号')" />
                    <x-text-input id="phone_number" name="phone_number" type="text" class="mt-1 block w-full"
                        :value="$shop->phone_number" required autocomplete="phone_number" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="website" name="website" type="text" class="mt-1 block w-full"
                        :value="$shop->website" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="youtube" name="youtube" type="text" class="mt-1 block w-full"
                        :value="$shop->youtube" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="line" name="line" type="text" class="mt-1 block w-full"
                        :value="$shop->line" placeholder="URL" />
                ...
                <div class="mt-4">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-4">
                            <x-radio-input id="active" name="status" value="1" :checked="old('status', $shop->status) == '1'" />
                            <x-radio-label for="active" :value="__('利用中')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="inactive" name="status" value="0" :checked="old('status', $shop->status) == '0'" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="established_date" name="established_date" type="date"
                        class="mt-1 block w-full" :value="$shop->established_date" autocomplete="established_date"
                        placeholder="Date" />
