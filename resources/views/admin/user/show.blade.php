<x-app-layout>
  ...
  <x-slot name="breadcrumb">
      ...
      <x-link-button name="index" href="{{ route('admin.user.index') }}" />
  </x-slot>
                  ...
                  <x-user-table>
                      <tbody class="divide-y divide-red-200">
                          ...
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span
                                      class="text-sm text-gray-400 mr-2">セイ:</span>{{ $userProfile->lastname_kana }}
                              </td>
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span
                          ...
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span
                                      class="text-sm text-gray-400 mr-2">都道府県名:</span>{{ $userProfile->address1 }}
                              </td>
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span
                                      class="text-sm text-gray-400 mr-2">市区町村名:</span>{{ $userProfile->address2 }}
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                  <span
                                      class="text-sm text-gray-400 mr-2">地域名:</span>{{ $userProfile->address3 }}
                              </td>
                          </tr>
                          <tr>
                              <th class="border border-slate-300 bg-gray-100 px-4 py-3 font-medium text-left"></th>
