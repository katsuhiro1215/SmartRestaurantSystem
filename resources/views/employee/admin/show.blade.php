                  ...
                  <x-user-table>
                      <tbody class="divide-y divide-red-200">
                          ...
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span class="text-sm text-gray-400 mr-2">セイ:</span>{{ $adminProfile->lastname_kana }}
                              </td>
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span
                          ...
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span class="text-sm text-gray-400 mr-2">都道府県名:</span>{{ $adminProfile->address1 }}
                              </td>
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                  <span class="text-sm text-gray-400 mr-2">市区町村名:</span>{{ $adminProfile->address2 }}
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                  {{ $adminProfile->membership_status }}
                              </td>
                          </tr>
                      </tbody>
                  </x-user-table>
