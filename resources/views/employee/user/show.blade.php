<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        ...
        <x-link-button name="index" href="{{ route('employee.user.index') }}" />
    </x-slot>

    <x-grid>
        <div class="bg-green-300 border border-red-300 rounded px-4 py-3 col-span-1 sm:col-span-2 md:col-span-1">
            <h2 class="text-lg">User Profile</h2>

            <div class="mt-4">
                <img src="{{ !empty($userProfile->user_photo_path) ? url('storage/users/' . $userProfile->user_photo_path) : url('upload/kids.jpg') }}"
                    alt="" class="rounded-full w-36 h-36 mx-auto">
            </div>
            <div class="mt-4 text-center">
                <h3>名前: {{ $userProfile->full_name }}</h3>
            </div>
        </div>
                        ...
                        <tbody class="divide-y divide-red-200">
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">姓:</span>{{ $userProfile->lastname }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">名:</span>{{ $userProfile->firstname }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">セイ:</span>{{ $userProfile->lastname_kana }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span
                                        class="text-sm text-gray-400 mr-2">メイ:</span>{{ $userProfile->firstname_kana }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">生年月日:</span>{{ $userProfile->birth }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                            ...
                            <tr>
                                ...
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">都道府県名:</span>{{ $userProfile->address1 }}
                                </td>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left">
                                    <span class="text-sm text-gray-400 mr-2">市区町村名:</span>{{ $userProfile->address2 }}
                                </td>
                            </tr>
                            <tr>
                                <th class="border border-slate-300 bg-gray-100 px-4 py-3 font-medium text-left"></th>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                    <span class="text-sm text-gray-400 mr-2">地域名:</span>{{ $userProfile->address3 }}
                                </td>
                            </tr>
                            <tr>
                                <th class="border border-slate-300 bg-gray-100 px-4 py-3 font-medium text-left"></th>
                                <td class="border border-slate-300 px-4 py-3 font-medium text-left" colspan="2">
                                    {{ $userProfile->address4 }}</td>
                            </tr>
                            <tr>
