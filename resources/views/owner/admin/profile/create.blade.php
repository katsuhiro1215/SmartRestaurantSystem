<x-app-layout>
    ...
    <div class="w-full mx-auto px-4 py-3 overflow-auto">
        @foreach ($errors->all() as $error)
            <li>{{ $error }}</li>
        @endforeach
        <form method="POST" action="{{ route('owner.adminProfile.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="w-full">
            ...
            <x-grid>
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="website" name="website" type="text" class="mt-1 block w-full"
                        :value="old('website')" autocomplete="website" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="youtube" name="youtube" type="text" class="mt-1 block w-full"
                        :value="old('youtube')" autocomplete="youtube" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="line" name="line" type="text" class="mt-1 block w-full"
                        :value="old('line')" autocomplete="line" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-4">
                            <x-radio-input id="superAdmin" name="role" value="Super Admin" checked />
                            <x-radio-label for="superAdmin" :value="__('Super Admin')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="admin" name="role" value="Admin" />
                            <x-radio-label for="admin" :value="__('Admin')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="subAdmin" name="role" value="Sub Admin" />
