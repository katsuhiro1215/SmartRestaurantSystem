<x-app-layout>
    ...
    <div class="w-full mx-auto px-4 py-3 overflow-auto">
        @foreach ($errors->all() as $error)
            <li>{{ $error }}</li>
        @endforeach
        <form method="POST" action="{{ route('owner.adminProfile.update', ['adminProfile' => $adminProfile->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="w-full">
            ...
            <x-grid>
                <div class="mt-4 col-span-2 row-span-3">
                    ...
                    <x-text-input id="image" name="admin_photo_path" type="file" class="mt-1 block w-full"
                        :value="$adminProfile->admin_photo_path" />
                    <img id="showImage"
                        src="{{ !empty($adminProfile->admin_photo_path) ? url('storage/admins/' . $adminProfile->admin_photo_path) : url('upload/employees.jpg') }}"
                        alt="" class="rounded-full w-56 h-56 shadow">
                    <x-input-error class="mt-2" :messages="$errors->get('admin_photo_path')" />
                </div>
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="lastname" name="lastname" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->lastname" required />
                ...
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="firstname" name="firstname" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->firstname" required />
                ...
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="lastname_kana" name="lastname_kana" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->lastname_kana" required />
                ...
                <div class="mt-4 col-span-1">
                    ...
                    <x-text-input id="firstname_kana" name="firstname_kana" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->firstname_kana" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="birth" name="birth" type="date" class="mt-1 block w-full"
                        :value="$adminProfile->birth" autocomplete="birth" />
                ...
                <div class="mt-4">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-4">
                          <x-radio-input id="male" name="gender" value="男性" :checked="old('gender', $adminProfile->gender) === '男'" />
                            <x-radio-label for="male" :value="__('男性')" />
                        </div>
                        <div class="flex items-center mr-4">
                          <x-radio-input id="female" name="gender" value="女性" :checked="old('gender', $adminProfile->gender) === '女'" />
                            <x-radio-label for="female" :value="__('女性')" />
                        </div>
                        <div class="flex items-center mr-4">
                          <x-radio-input id="others" name="gender" value="その他" :checked="old('gender', $adminProfile->gender) === 'その他'" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="zipcode" name="zipcode" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->zipcode" autocomplete="zipcode" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address1" name="address1" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->address1" autocomplete="address1" placeholder="都道府県名を入力してください。" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address2" name="address2" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->address2" autocomplete="address2" placeholder="市区町村名を入力してください。" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="address3" name="address3" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->address3" autocomplete="address3" placeholder="地域名を入力してください。" />
                ...
                <div class="mt-4 col-span-3">
                    ...
                    <x-text-input id="address4" name="address4" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->address4" autocomplete="address4" placeholder="それ以降を入力してください。" />
                    <x-input-error class="mt-2" :messages="$errors->get('address4')" />
                </div>
                <div class="mt-4">
                    <x-input-label for="phone_number" :value="__('電話番号')" />
                    <x-text-input id="phone_number" name="phone_number" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->phone_number" autocomplete="phone_number" placeholder="電話番号を入力してください。" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="website" name="website" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->website" autocomplete="website" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="facebook" name="facebook" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->facebook" autocomplete="facebook" placeholder="URL" />
                    <x-input-error class="mt-2" :messages="$errors->get('facebook')" />
                </div>
                <div class="mt-4 col-span-2">
                    <x-input-label for="twitter" :value="__('Twitter')" />
                    <x-text-input id="twitter" name="twitter" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->twitter" autocomplete="twitter" placeholder="URL" />
                    <x-input-error class="mt-2" :messages="$errors->get('twitter')" />
                </div>
                <div class="mt-4 col-span-2">
                    <x-input-label for="instagram" :value="__('Instagram')" />
                    <x-text-input id="instagram" name="instagram" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->instagram" autocomplete="instagram" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="youtube" name="youtube" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->youtube" autocomplete="youtube" placeholder="URL" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <x-text-input id="line" name="line" type="text" class="mt-1 block w-full"
                        :value="$adminProfile->line" autocomplete="line" placeholder="URL" />
                ...
                <div class="mt-4">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-4">
                            <x-radio-input id="active" name="status" value="利用中" :checked="old('status', $adminProfile->status) === '利用中'" />
                            <x-radio-label for="active" :value="__('利用中')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="inactive" name="status" value="停止中" :checked="old('status', $adminProfile->status) === '停止中'" />
                ...
                <div class="mt-4 col-span-2">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-4">
                            <x-radio-input id="superAdmin" name="role" value="Super Admin" :checked="old('role', $adminProfile->role) === 'Super Admin'" />
                            <x-radio-label for="superAdmin" :value="__('Super Admin')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="admin" name="role" value="Admin" :checked="old('role', $adminProfile->role) === 'Admin'" />
                            <x-radio-label for="admin" :value="__('Admin')" />
                        </div>
                        <div class="flex items-center mr-4">
                            <x-radio-input id="subAdmin" name="role" value="Sub Admin" :checked="old('role', $adminProfile->role) === 'Sub Admin'" />
                            <x-radio-label for="subAdmin" :value="__('Sub Admin')" />
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="start_date" name="start_date" type="date" class="mt-1 block w-full"
                        :value="$adminProfile->start_date" autocomplete="start_date" placeholder="Date" />
