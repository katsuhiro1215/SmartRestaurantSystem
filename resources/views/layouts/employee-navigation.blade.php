    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('employee.dashboard') }}" class="flex ml-2 md:mr-24">
                    <x-application-logo />
                </a>
            </div>
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <div class="px-4 py-3" role="none">
                                <p class="text-sm text-gray-900 dark:text-white" role="none">{{ Auth::user()->employeeProfile->full_name }}</p>
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">{{ Auth::user()->email }}</p>
                            </div>
                            <x-slot name="content" role="none">
                                <li>
